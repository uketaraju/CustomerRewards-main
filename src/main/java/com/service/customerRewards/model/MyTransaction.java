...
public class MyTransaction extends Reward{
	...
	public MyTransaction(Long id, Customer customer, Double total, String description) {
		super();
		this.id = id;
	...
	public String toString() {
		return String.format("MyTransaction [id=%s, customer=%s, total=%s, description=%s]", id, customer,
				total, description);
	}
